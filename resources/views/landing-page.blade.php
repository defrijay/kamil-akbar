<title>Bengkel Kamil Akbar | {{ $title }}</title>
  ...
  <section id="pengalaman" class="my-5">
    ...
    <div class="row row-cols-1 row-cols-md-3 m-5 p-5 text-center">
      <div class="col">
        <div class="card mb-4 rounded-5 shadow-lg text-white" style="background-color: #4AA9AF;">
          ...
          <div class="card-body">
              <img src="img/alasan1.png" class="card-img-bottom" alt="...">
          </div>
        </div>
      </div>
      ...
      <div class="col">
        <div class="card mb-4 rounded-5 shadow-sm text-white shadow-lg" style="background-color: #4AA9AF;">
          <div class="card-header py-3">
  ...
  <!-- about -->
  <section id="about" class="rounded-top-5 text-white pt-3" style="background-color: #081F37;">
  ...
  <section id="pengalaman" class="my-5">
    ...
    <div class="row row-cols-1 row-cols-md-3 m-5 text-center">
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm text-white" style="background-color: #4AA9AF;">
          <div class="card-header py-3">
            <img src="img/orang.png"  class="card-img-top" style="background-color: #378489;"
              alt="...">
          </div>
          <div class="card-body">
        ...
        <div class="card mb-4 rounded-3 shadow-sm text-white" style="background-color: #4AA9AF;">
          ...
          <div class="card-body">
            ...
            <ul class="list-unstyled mt-3 mb-4">
              <p class="fs-6">Harganya murah jadi selalu langganan setiap mo service disini. Jadi bikin bahagia selalu disini!</p>
            </ul>
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm text-white" style="background-color: #4AA9AF;">
          ...
          <div class="card-body">
            ...
            <ul class="list-unstyled mt-3 mb-4">
              <p class="fs-6">Pelayannya ramah banget jadi ketagihan service motor disini dariapada di bengkel resminya soalnya selain harganya terjangkau, bengkelnya berkualitas</p>
            </ul>
          </div>
        </div>
      </div>
