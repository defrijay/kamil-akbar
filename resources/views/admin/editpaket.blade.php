                  ...
                  <div class="table-responsive-md">
                    <table class="table table-striped caption-top align-middle" id="kontak">
                      ...
                      <tbody>
                        ...
                        @method('put')
                        @csrf
                          <td><input type="text" name="nama_paket" placeholder="Nama Paket" value="{{$paket->nama_paket}}"></td>
                          <td><input type="text" name="harga" placeholder="Harga" value="{{$paket->harga}}"></td>
                        </tr>
                    </tbody>
                </table>
