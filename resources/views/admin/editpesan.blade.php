                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Provident saepe deleniti temporibus aliquid
                  ...
                  <div class="table-responsive-md">
                    <table class="table table-striped caption-top align-middle" id="kontak">
                      ...
                      <tbody>
                        <tr>
                        <form action="/pesan/{{$pesan->id_pesan}}" method="POST">
                        @method('put')
                        @csrf
                          <td><input type="text" name="nama_pengirim" placeholder="Nama Pengirim" value="{{$pesan->nama_pengirim}}"></td>
                          <td><input type="text" name="email_pengirim" placeholder="E-mail Pengirim" value="{{$pesan->email_pengirim}}"></td>
                          <td><input type="text" name="pesan" placeholder="Pesan" value="{{$pesan->pesan}}"></td>
                        </tr>
                    </tbody>
                </table>
